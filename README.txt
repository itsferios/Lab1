...
\paperw11900\paperh16840\margl1440\margr1440\vieww14080\viewh14740\viewkind0
...
\
1. Analysis with \'93Rapporti_di_lavoro_di_attivati.csv\'94\
\
...
We noted that in the years 2018, 2019, 2020 and 2021, \'93Lavoro Domestico\'94 has increased, while contracts for \'93Tirocinio\'94 decreased. \
\
...
What is noticeable is that the hotel (\'93Alberghi\'94) and catering (\'93Ristorazione con somministrazione\'94)  sector has decreased, while the \'93Attivit\'e0 di famiglie e convivenze come datori di lavoro per personale domestico\'94.\
												\
...
\
2. Analysis with \'93Rapporti_di_lavoro_di_prorogati.csv\'94 + \'93Rapporti_di_lavoro_di_cessati.csv\'94\
\
...
After having created two datasets specifically for the two types of contracts ("selectedprorogati", "selectedcessati"), we have created a new DataFrame (\'93union\'94), which is the union of the two. \
This has been done in order to represent the data in the pie chart, where we can see the number of contracts extended is greater than those terminated, despite the end of covid and the removal of \'93Blocco dei licenziamenti\'94. For each of the categories of contract, one can also see the relationship between the various provinces.\
...
\
3.2 \cb2 \expnd0\expndtw0\kerning0
For the sectors of the previous point, what is the average/median age?\cb1 \kerning1\expnd0\expndtw0 \
